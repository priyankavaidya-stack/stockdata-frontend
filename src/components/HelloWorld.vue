<template>
  <div class="container">
    ...
    <div class="box">
        <div class="input-box">
            <input class="equity-input" v-model="symbol" type="text" placeholder="Enter equity name..." />
    ...
    <button @click="fetchData" class="fetch-btn"  :style="{ backgroundColor: isDisabled ? 'gray' : '#006400',  opacity: isDisabled ? 0.6 : 1, cursor: isDisabled ?  'not-allowed' : 'pointer' }" :disabled="isDisabled">Fetch Data</button>
    ...
    methods: {
        checkEmpty() {
            if (this.symbol) {
                ...
                this.errorMessage = 'Please enter equity symbol';
            }
        ...
        this.checkEmpty();
            if (!this.isDisabled){
                ...
                this.clearChartContainer(); // Clear the chart container before rendering the new chart
